...
//        System.out.print("Key\t\t: "+new String(pbUserKey).trim());
//
//        for (int i = 0; i < 16; i++)
//        {
...
//        KLogger.debug("ENCRYPT Plaintext\t: "+new String(pbData).trim());
...
//        KLogger.debug("ENCRYPT Ciphertext\t: "+new String(pbCipher).trim());
//
//        for (int i = 0; i < 16; i++)
//        {
...
//        KLogger.debug("ENCRYPT base64 text \t: "+base64trlog.trim());
//        KLogger.toHexlog("SEED", pbCipher);
...
//        KLogger.debug("Ciphertext\t: "+new String(pbCipher).trim());
//        for (int i = 0; i < 16; i++)
//        {
//            System.out.print(Integer.toHexString(0xff & pbCipher[i]) + " ");
//        }

//        KLogger.debug("DECRYPT Plaintext\t: "+ new String(pbPlain).trim());
    ...
    public static void main(String[] args){
        //log.debug(new String(SEED_KISA.ENCRYPT("jdbc:mysql://211.251.235.67:3306/bitFriends?useUnicode=true&autoReconnect=true&useSSL=false&characterEncoding=utf8".getBytes())));
        //log.debug(new String(SEED_KISA.ENCRYPT("jdbc:mysql://172.16.1.106:3306/bitFriends?useUnicode=true&characterEncoding=utf8".getBytes())));
        ...
        byte[] encUrlByte = SEED_KISA.ENCRYPT("jdbc:log4jdbc:mariadb://106.240.164.71:44006/doollee?serverTimezone=UTC".getBytes());
        ...
        System.out.println(new String(SEED_KISA.DECRYPT(encUrl)));
        
        byte[] encUsernameByte = SEED_KISA.ENCRYPT("doollee".getBytes());
        String encUsername = new String(encUsernameByte, StandardCharsets.UTF_8);
        System.out.println("encUsername : "+encUsername);       
        System.out.println(new String(SEED_KISA.DECRYPT(encUsername)));
        
        byte[] encPasswordByte = SEED_KISA.ENCRYPT("EnfflEnffl12#$".getBytes());
        String encPassword = new String(encPasswordByte, StandardCharsets.UTF_8);
        System.out.println("encPassword : "+encPassword);       
        System.out.println(new String(SEED_KISA.DECRYPT(encPassword)));
