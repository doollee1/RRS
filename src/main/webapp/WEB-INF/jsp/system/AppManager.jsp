...
<%
	/**
	 * @Name : AppManager
	 * @Description : Program Manager (프로그램 관리 화면)
	 */
%>
...
--%>
	...
	/********************************************
	 * @Subject : 중메뉴 그리드 행 클릭 시
	 * @Content : 해당 중메뉴의 하위 프로그램목록 조회
	 * @Since   : 2024.07.11
	 * @Author  :
	 ********************************************/
