...
<html>
	...
	<body id="mainbody" class="mainbody">
			<!-- 공통 JS/CSS 시작 -->
			<tiles:insertAttribute name="imp"  />
			<!-- 공통 JS/CSS 끝 -->
			...
			<div id="main_contents" class="content_wrap">
				<div id="tabs">
					<div style="position:absolute;left:calc(100% - 91px);top:8px;"><input type="button" id="tabsAllClose" style="outline:none;" value="Close All"></div>
					<ul>
					  <li><a href="#tabs-1">&nbsp;에이전시예약관리&nbsp;</a></li>
					</ul>
					
					<div id="tabs-1">
						<iframe src="/reserve/agencyReserveList.do" id="icontent" name="icontent" style="width:100%;height:100%;"  allowfullscreen></iframe>
					</div>
				</div>
			</div>
			<!-- 메인 끝 -->
