...
<c:import url="../import/frameTop.jsp">
	<c:param name="progcd" value="RV06" />
</c:import>
...
--%>
	 ...
	 * @See     : createQuotationGrid() / agencyReservePopup() / cSearch()
	 * @Since   : 2024.07.11
	 * @Author  : 
	 ********************************************/
	function fn_Init(){
	...
	/******************************************** 
	 * @Subject : 에이전신 예약 등록 버튼 함수
	 * @Content : 
	 * @See     : agencyReservePopup()
	 * @Since   : 2024.07.30
	 * @Author  : 
	 ********************************************/
	function cAdd() {		
	 ...
	 * @Author  : 
	 ********************************************/
	function agencyReservePopup(param) {
		var url = "/reserve/agencyReserveRegi.do";
