...
/********************************************
 * @Subject : 이미지 업로드 팝업창
 * @Content : tinymce(텍스트에디터)의 이미지 업로드 버튼 클릭시
 * @Since   : 2024.07.11
 * @Author  :
 ********************************************/
...
/********************************************
 * @Subject : 저장 버튼 클릭
 * @Content : 첨부파일이 있으면 첨부파일 저장 후 공지사항 저장
              첨부파일이 없으면 공지사항만 저장
 * @Since   : 2024.07.11
 * @Author  :
 ********************************************/
...
/********************************************
 * @Subject : 공지사항 상세 정보 가져오기
 * @Content : 공지사항 상세화면에서 [수정] 버튼으로 넘어올때
 * @Since   : 2024.07.11
 * @Author  :
 ********************************************/
...
/********************************************
 * @Subject : 공지사항 첨부파일
 * @Content : 첨부파일이 있는 경우 다운로드 링크 생성
 * @Since   : 2024.07.11
 * @Author  :
 ********************************************/
