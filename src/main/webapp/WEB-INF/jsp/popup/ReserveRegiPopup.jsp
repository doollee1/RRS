...
.pbtn_default {
	...
	border: 1px solid #a9cbeb !important;
...
<div id="p_reserveRegi">
	<form id="frmReserveInfo" action="#">
		<div id="pop_ct_form_wrap">
			<input type="hidden" name="PRC_STS" id="PRC_STS" value="" /> <input
				type="hidden" name="PRC_STS_NM" id="PRC_STS_NM" value="" /> <input
				type="hidden" name="EMAIL" id="EMAIL" value="" /> <input
				type="hidden" name="PAY_AMT" id="PRV_PAY_AMT" value="" /> <input
				type="hidden" name="DCT_AMT" id="PRV_DCT_AMT" value="" /> <input
				type="hidden" name="BAL_AMT" id="PRV_BAL_AMT" value="" />
			...
			<table class="pop_tblForm">
				...
				<tr class="idTest">
					<th>ID</th>
					<td class="medium_td"><input type="text" id="USER_ID"
						name="USER_ID" /> <!-- <button type="button" class="pbtn_default" id="btn_search">아이디검색</button> -->
					</td>
				</tr>
				<tr>
					<th><s:message code='reservation.date' /></th>
					<td class="medium_td"><input type="text" id="REQ_DT"
						name="REQ_DT" data-type="date" /></td>
					<th><s:message code='reservation.tel' /></th>
					<td><input type="text" class="cmc_txt" id="REQ_TEL_NO"
						name="REQ_TEL_NO" pattern="[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}"
						maxlength="13" placeholder="예) 010-1234-5678" /></td>
				</tr>
				<tr>
					<th><s:message code='reservation.Kname' /></th>
					<td><input type="text" class="cmc_txt" id="REQ_HAN_NM"
						name="REQ_HAN_NM" /></td>
					<th><s:message code='reservation.Ename' /></th>
					<td><input type="text" class="cmc_txt" id="REQ_ENG_NM"
						name="REQ_ENG_NM" /></td>
				</tr>
				<tr>
					<th><s:message code='reservation.mem_gbn' /></th>
					<td><select id="MEM_GBN" name="MEM_GBN" class="cmc_combo"
						style="width: 62%;">
							<option value="">--
								<s:message code='system.select' />--
							</option>
					...
					<td><select id="AGN_CD" name="AGN_CD" class="cmc_combo"
						style="width: 62%;">
							<option value="">--
								<s:message code='system.select' />--
							</option>
				...
				<tr>
					...
					<td><input type="text" class="cmc_txt" id="CHK_IN_DT"
						name="CHK_IN_DT" data-type="date" style="width: 51.5%;" /></td>
					<th><s:message code='reservation.checkOutDt' /></th>
					<td><input type="text" class="cmc_txt" id="CHK_OUT_DT"
						name="CHK_OUT_DT" data-type="date" style="width: 51.5%;" /></td>
				</tr>
				<tr>
					<th><s:message code='reservation.roomType' /></th>
					<td><select id="ROOM_TYPE" name="ROOM_TYPE" class="cmc_combo"
						style="width: 62%;">
							<option value="">--
								<s:message code='system.select' />--
							</option>
				...
				<tr>
					...
					<td><select id="FLIGHT_IN" name="FLIGHT_IN" class="cmc_combo"
						style="width: 62%;">
							<option value="">--
								<s:message code='system.select' />--
							</option>
					...
					<td><select id="FLIGHT_OUT" name="FLIGHT_OUT"
						class="cmc_combo" style="width: 62%;">
							<option value="">--
								<s:message code='system.select' />--
							</option>
				...
				<tr>
					...
					<td><select id="PROD_CD" name="PROD_CD" class="cmc_combo"
						style="width: 150%;">
							<option value="">--
								<s:message code='system.select' />--
							</option>
				...
				<tr>
					...
					<td><input type="text" class="cmc_txt" id="TOT_PERSON"
						name="TOT_PERSON" value="0"
						style="width: 60px; text-align: right;" />명</td>
					<th><s:message code='reservation.resortNum' /></th>
					<td><input type="text" class="cmc_txt" id="CONFIRM_NO"
						name="CONFIRM_NO" /></td>
				</tr>
				<tr>
					...
					<td colspan="5">
						<div style="display: inline-flex;">
							...
							<input type="text" id="R_PERSON" name="R_PERSON"
								style="width: 60px; text-align: right;" value="0" />명
							<s:message code='reservation.roundN' />
							<input type="text" id="N_PERSON" name="N_PERSON"
								style="width: 60px; text-align: right;" value="0" />명
							<s:message code='reservation.infant' />
							<input type="text" id="K_PERSON" name="K_PERSON"
								style="width: 60px; text-align: right;" value="0" />명
						</div>
					</td>
				</tr>
				<tr>
					...
					<td><select id="PICK_GBN" name="PICK_GBN" class="cmc_combo"
						style="width: 100px;" disabled>
							<c:forEach var="i" items="${region}">
								<option value="${i.CODE}">${i.CODE_NM}</option>
							</c:forEach>
					</select> <input type="text" id="PER_NUM_CNT" name="PER_NUM_CNT"
						style="width: 60px; text-align: right;" value="0" disabled>명
						<input type="hidden" id="PCK_PROD_SEQ" name="PCK_PROD_SEQ">
						<button type="button" class="pbtn_default openPop"
							id="insertPickGbn">등록</button></td>
					<th><s:message code='reservation.lateCheckout' /></th>
					<td><input type="radio" name="LATE_CHECK_OUT" value="1">여
						<input type="radio" name="LATE_CHECK_OUT" value="2">부</td>
				</tr>
				<tr>
					<th><s:message code='reservation.addSingle' /></th>
					<td><input type="text" id="ADD_R_S_PER" name="ADD_R_S_PER"
						value="0" style="width: 60px; text-align: right" ;"/>명 <input
						type="text" id="ADD_R_S_DAY" name="ADD_R_S_DAY" value="0"
						style="width: 60px; text-align: right" ;"/>일 <input type="text"
						id="ADD_R_S_CNT" name="ADD_R_S_CNT" value="0"
						style="width: 60px; text-align: right" ;"/>개</td>
					<th><s:message code='reservation.addPremium' /></th>
					<td><input type="text" id="ADD_R_P_PER" name="ADD_R_P_PER"
						value="0" style="width: 60px; text-align: right" ;/>명 <input
						type="text" id="ADD_R_P_DAY" name="ADD_R_P_DAY" value="0"
						style="width: 60px; text-align: right" ;/>일 <input type="text"
						id="ADD_R_P_CNT" name="ADD_R_P_CNT" value="0"
						style="width: 60px; text-align: right" ;/>개</td>
				</tr>
				<tr>
					<th>트윈/더블</th>
					<td><input type="text" id="CNT_D1" name="CNT_D1"
						style="width: 60px; text-align: right" ;" value="0" />개 <input
						type="text" id="CNT_D2" name="CNT_D2"
						style="width: 60px; text-align: right" ;" value="0" />개</td>
					<th>프리미엄 트윈/더블</th>
					<td><input type="text" id="CNT_P1" name="CNT_P1"
						style="width: 60px; text-align: right" ;" value="0" />개 <input
						type="text" id="CNT_P2" name="CNT_P2"
						style="width: 60px; text-align: right" ;" value="0" />개</td>
				</tr>
				<tr>
					<th><s:message code='reservation.arrPickup' /></th>
					<td><select id="PICK_IN" name="PICK_IN" class="cmc_combo"
						style="width: 62%;">
							<option value="">--
								<s:message code='system.select' />--
							</option>
					...
					<td><select id="PICK_OUT" name="PICK_OUT" class="cmc_combo"
						style="width: 62%;">
							<option value="">--
								<s:message code='system.select' />--
							</option>
				...
				<tr>
					...
					<td><input type="text" id="TOT_AMT" name="TOT_AMT"
						style="text-align: right" value="0" class="withComma"
				...
				<tr>
					...
					<td><input type="text" id="DCT_AMT" name="DCT_AMT"
						style="text-align: right" value="0" class="withComma" />원</td>
					<th><s:message code='reservation.balancePrice' /></th>
					<td>
						<div style="display: inline-flex;">
							<input type="text" id="BAL_AMT" name="BAL_AMT"
								style="text-align: right" value="0" class="withComma"
								readonly="readonly" />원
						</div>
					</td>
				...
				<tr>
					...
					<td><input type="text" class="cmc_txt" id="DEP_IN_DT"
						name="DEP_IN_DT" data-type="date" /></td>
					<th><s:message code='reservation.payAmt' /></th>
					<td><input type="text" id="PAY_AMT" name="PAY_AMT"
						style="text-align: right" value="0" class="withComma" />원
						<button type="button" class="pbtn_default openPop"
							id="btn_deposit" disabled>입금완료</button></td>
				</tr>
				<tr>
					<th><s:message code='reservation.expdt' /></th>
					<td><input type="text" class="cmc_txt" id="EXP_DT"
						name="EXP_DT" data-type="date" readonly="readonly" /></td>
				</tr>
				<tr>
					<th><s:message code='reservation.moreDetail' /></th>
					<td colspan="5"><textarea id="REMARK" name="REMARK" rows="5"
				...
				<tr>
					...
					<td colspan="2">
						<div style="display: inline-flex;">
							<input type="checkbox" name="RND_CHG_YN1" id="RND_CHG_YN1">토요일
							오전 <input type="checkbox" name="RND_CHG_YN2" id="RND_CHG_YN2">일요일
							오전 ※ 미체크시 기본은 오후임.
						</div>
					</td>
				</tr>
...
<script type="text/javascript">
	$(function() {
		...
		function fn_init(receivedData) {
			var day = new Date();
			var today = String(day.getFullYear())
					+ String((day.getMonth() + 1)) + String(day.getDate());
			$('#REQ_DT').val($.datepicker.formatDate('yy.mm.dd', new Date()))
					.attr("readonly", true);
			seq = receivedData.SEQ;
			req_dt = receivedData.REQ_DT;
			if (fn_empty(seq || req_dt)) { //신규
				$(".ui-dialog-title").text(
						'<s:message code='reservation.registration'/>');
				...
				vflag = "new";
				$(
						"#TOT_AMT , #PAY_AMT , #DCT_AMT , #BAL_AMT , #DEP_IN_DT , #BAL_IN_DT , #DEP_AMT , #EXP_DT , #INV_REG_DT")
						.attr("disabled", true);
			} else { // 상세
				$("#USER_ID , #MEM_GBN").attr("disabled", true);
				$(".ui-dialog-title").text(
						'<s:message code='reservation.detail'/>');
				initSelect();
				vflag = "detail";
			}

			$('#DEP_IN_DT, #BAL_IN_DT , #INV_REG_DT , #EXP_DT').datepicker({
				dateFormat : 'yy.mm.dd',
				showOn : 'both'
		...
		function fn_dataSet(data) {
			$.each(data, function(key, val) {
				if (key == "TOT_PERSON" || key == "R_PERSON"
						|| key == "N_PERSON" || key == "K_PERSON"
						|| key == "ADD_R_S_PER" || key == "ADD_R_S_DAY"
						|| key == "ADD_R_S_CNT" || key == "ADD_R_S_CNT"
						|| key == "ADD_R_P_PER" || key == "ADD_R_P_DAY"
						|| key == "ADD_R_P_CNT" || key == "CNT_D1"
						|| key == "CNT_D2" || key == "CNT_P1"
						|| key == "CNT_P2" || key == "TOT_AMT"
						|| key == "DCT_AMT" || key == "BAL_AMT"
						|| key == "DEP_AMT" || key == "PAY_AMT"
						|| key == "PRV_DCT_AMT" || key == "PRV_BAL_AMT"
						|| key == "PRV_PAY_AMT") {
				...
				} else if (key == "CHK_IN_DT" || key == "CHK_OUT_DT"
						|| key == "REQ_DT" || key == "DEP_IN_DT"
						|| key == "BAL_IN_DT" || key == "EXP_DT"
						|| key == "INV_REG_DT") {
					$('[name=' + key + ']')
							.val(Util.converter.dateFormat1(val));
				} else {
					$('[name=' + key + ']').val(val);
				}
			});
			...
			if (!fn_empty(data.LATE_CHECK_OUT)) {
				$('[name=LATE_CHECK_OUT][value=' + data.LATE_CHECK_OUT + ']')
						.prop("checked", true);
			}
		...
		function formatPhoneNumber(input) {
			...
			if (length === 8) {
				result = cleanInput.replace(/(\d{4})(\d{4})/, '$1-$2');
					...
					&& (length === 9 || length === 10)) {
				result = cleanInput.replace(/(\d{2})(\d{3,4})(\d{4})/,
						'$1-$2-$3');
			} else if (!cleanInput.startsWith("02")
					&& (length === 10 || length === 11)) {
				result = cleanInput.replace(/(\d{3})(\d{3,4})(\d{4})/,
						'$1-$2-$3');
			} else {
				result = undefined;
			}
		...
		function saveReserveInfo() {
			...
			var obj = {
				...
				"RND_CHG_YN1" : $("#RND_CHG_YN1").is(":checked") == true ? "Y"
						: "N",
				"RND_CHG_YN2" : $("#RND_CHG_YN2").is(":checked") == true ? "Y"
						: "N",
				...
				"BAL_IN_DT" : $("#BAL_IN_DT").val().replaceAll(".", ""),
