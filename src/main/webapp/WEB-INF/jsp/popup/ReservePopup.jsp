...
$(function() {
	...
	function fn_init(receivedData){
		...
		/*도착항공기편 / 출발항공기편 */
		$("#FLIGHT_IN_DT, #FLIGHT_IN, #FLIGHT_IN_HH, #FLIGHT_IN_MM").attr("disabled",true);
		$("#FLIGHT_OUT_DT, #FLIGHT_OUT, #FLIGHT_OUT_HH, #FLIGHT_OUT_MM").attr("disabled",true);
		/*early체크인 / late체크아웃 */
	...
	function createGrid(){
		...
		var colModel = [
						...
						, { name: 'FLIGHT_IN_DT'  , width : 84 , align: 'center', editable:false, editoptions:{maxlength:100}}
						...
						, { name: 'FLIGHT_OUT_DT' , width : 84 , align: 'center', editable:false, editoptions:{maxlength:100}}
